  ...
  function injectStyles() {
    ...
    css.textContent = `
      .x4-chat-fab {
        ...
        color: #fff;
        border: none;
        box-shadow: 0 8px 24px rgba(158, 116, 50, 0.35);
        font-size: 28px;
        display: flex;
        align-items: center;
      ...
      .x4-chat-window {
        ...
        background: #FFFFFF;
        border-radius: 20px;
        box-shadow: 0 20px 60px rgba(28, 35, 51, 0.18);
        display: flex;
      ...
      .x4-chat-header {
        background: linear-gradient(135deg, #1C2333, #2A3449);
        color: #fff;
        padding: 16px 18px;
        display: flex;
        align-items: center;
      ...
      .x4-chat-title span { font-size: 12px; opacity: 0.8; }
      .x4-chat-close {
      ...
      .x4-chat-message a { color: #9E7432; text-decoration: underline; }
      .x4-chat-message.bot {
      ...
      .x4-chat-chip {
        background: #fff;
        border: 1px solid rgba(201, 168, 89, 0.45);
        color: #9E7432;
        border-radius: 16px;
        padding: 6px 12px;
        font-size: 12px;
      ...
      .x4-chat-chip:hover { background: #C5A059; color: #fff; }
      .x4-chat-footer {
        padding: 12px 14px;
        background: #fff;
        border-top: 1px solid rgba(201, 168, 89, 0.2);
        display: flex;
        gap: 10px;
      }
      .x4-chat-input {
      ...
      .x4-chat-input:focus { border-color: #C5A059; }
      .x4-chat-send {
        width: 40px;
        height: 40px;
        border-radius: 50%;
